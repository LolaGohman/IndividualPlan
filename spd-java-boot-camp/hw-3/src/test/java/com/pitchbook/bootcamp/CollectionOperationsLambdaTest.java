...
public class CollectionOperationsLambdaTest {
    ...
    public void should_create_list_of_elements_provided_by_supplier() {
        List<Example> actualResult = collectionOperations.generate(() -> new Example(), 3);
    ...
    public void should_create_list_of_objects_provided_by_special_function() {
        ...
        List<Integer> actualResult = collectionOperations.iterate(2, x -> x + 3, 4);
    ...
    public void should_iterate_into_empty_list_when_count_is_0() {
        List<Integer> actualResult = collectionOperations.iterate(2, x -> x + 3, 0);
        assertTrue(actualResult.isEmpty());
    }
    ...
    public void should_return_list_of_elements_matches_the_rule() {
        ...
        List<Integer> actualResult = collectionOperations.filter(source, x -> x > 3);
    ...
    public void should_return_list_of_objects_that_do_not_match_the_rule() {
        ...
        List<Integer> actualResult = collectionOperations.filterNot(source, x -> x > 3);
    ...
    public void should_remove_only_first_element_that_matches_the_rule() {
        ...
        List<Integer> actualResult = collectionOperations.removeFirst(source, x -> x > 3);
    ...
    public void should_remove_only_last_element_that_matches_the_rule() {
        ...
        List<Integer> actualResult = collectionOperations.removeLast(source, x -> x > 3);
    ...
    public void should_remove_all_elements_that_match_the_rule() {
        ...
        List<Integer> actualResult = collectionOperations.removeAll(source, x -> x < 4);
        List<Integer> expectedResult = Arrays.asList(4, 5);
    ...
    public void should_return_true_if_at_least_one_element_matches_the_rule() {
        ...
        assertTrue(collectionOperations.anyMatch(source, x -> x == 1));
    }
    ...
    public void should_return_false_if_none_of_elements_matches_the_rule() {
        ...
        assertFalse(collectionOperations.anyMatch(source, x -> x == 1));
    }
    ...
    public void should_return_true_only_if_all_elements_match_the_rule() {
        ...
        assertTrue(collectionOperations.allMatch(source, x -> x > 0));
    }
    ...
    public void should_return_false_if_at_least_one_element_does_not_match_the_rule() {
        ...
        assertFalse(collectionOperations.allMatch(source, x -> x > 1));
    }
    ...
    public void should_return_true_only_if_none_of_elements_matches_the_rule() {
        ...
        assertTrue(collectionOperations.noneMatch(source, x -> x > 10));
    }
    ...
    public void should_return_false_if_at_least_one_element_matches_the_rule() {
        ...
        assertFalse(collectionOperations.noneMatch(source, x -> x > 3));
    }
    ...
    public void should_transform_all_elements_into_another_types() {
        ...
        List<String> actualResult = collectionOperations.map(source, x -> x.toString());
    ...
    public void should_find_max_element() {
        ...
        Optional<Integer> actualResult = collectionOperations.max(source, (a, b) -> a.compareTo(b));
    ...
    public void should_find_min_element() {
        ...
        Optional<Integer> actualResult = collectionOperations.min(source, (a, b) -> a.compareTo(b));
    ...
    public void should_distinct_elements_by_comparator() {
        ...
        List<Integer> actualResult = collectionOperations.distinctBy(source, (a, b) -> a.compareTo(b));
        List<Integer> expectedResult = Arrays.asList(1, 9, 6, 3, 0, 5);
    ...
    public void should_apply_some_action_to_each_object() {
        ...
        Consumer<Integer> consumer = x -> testList.add(x);
    ...
    public void should_return_one_element_from_reduced_list() {
        ...
        Optional<Integer> actualResult = collectionOperations.reduce(source, (a, b) -> a + b);
    ...
    public void should_reduce_list_of_elements_with_some_seed() {
        ...
        int actualResult = collectionOperations.reduce(15, source, (a, b) -> a + b);
    ...
    public void should_partition_elements_by_some_rule() {
        ...
        Map<Boolean, List<Integer>> actualResult = collectionOperations.partitionBy(source, x -> x > 3);
    ...
    public void should_convert_elements_into_map_by_some_functions() {
        List<String> source = Arrays.asList("ab", "abc", "gh", "a", "c");
        Function<String, Integer> valueFunction = x -> x.length();
        BinaryOperator<Integer> accumulator = (a, b) -> a + b;
        Function<String, String> keyFunction = (a) -> {
            if (a.length() == 1) {
                return "One";
            } else if (a.length() == 2) {
                return "Two";
