...
import com.pitchbook.bootcamp.collections.FaithfulPassengers
import org.testng.Assert
import org.testng.annotations.Test

class FaithfulPassengersTest {
    private fun testFaithfulPassengers(minTrips: Int, passengerIndexes: Set<Int>, tp: TaxiPark) {
        ...
        Assert.assertEquals(FaithfulPassengers.findFaithfulPassengers(tp, minTrips), expected, message)
    }
