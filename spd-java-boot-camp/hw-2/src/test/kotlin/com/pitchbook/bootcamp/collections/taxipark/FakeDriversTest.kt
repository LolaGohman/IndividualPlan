...
import com.pitchbook.bootcamp.collections.FakeDrivers
import org.testng.Assert
import org.testng.annotations.Test

class FakeDriversTest {
    private fun testFakeDrivers(fakeDriverIndexes: Set<Int>, tp: TaxiPark) {
        ...
        Assert.assertEquals(FakeDrivers.findAllDriversWhoDidntPerformAnyTrips(tp), expected, message)
    }

    @Test
    fun test0() = testFakeDrivers(setOf(0, 1, 2), taxiPark(0.rangeTo(2), 0.rangeTo(4)))
